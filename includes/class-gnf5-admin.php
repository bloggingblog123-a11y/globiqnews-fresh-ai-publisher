        ...
        <div class="wrap gnf5-wrap">
            ...
            <form method="post" action="options.php">
                ...
                <section class="gnf5-card">
                    ...
                    <p class="description">The service runs the verified Rank Math analyzer. WordPress keeps control of publishing. Writer API keys and WordPress passwords are not sent. A sleeping or unavailable service leaves articles as Draft and retries scoring.</p>
