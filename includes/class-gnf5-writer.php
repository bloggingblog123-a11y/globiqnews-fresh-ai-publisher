...
class GNF5_Writer {
    ...
    public static function repair_for_validation($article, $research, $errors, $cat_id=0) {
        ...
        $raw=self::gemini_json($prompt.self::seo_instruction().self::text_repair_instruction());if(is_wp_error($raw))return $raw;
