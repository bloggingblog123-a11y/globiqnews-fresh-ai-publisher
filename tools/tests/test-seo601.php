...
try{
    ...
    $s['categories'][$cat]['external_links']="https://broken.example.org/facts\nhttps://restricted.example.org/facts\nhttps://trusted.example.org/facts";update_option(GNF5_OPTION,$s);
    $external=GNF5_SEO::insert_external_links($article['content_html'],$id,$cat);
    v6(strpos($external,'https://trusted.example.org/facts')!==false && strpos($external,'nofollow')===false,'validated trusted editorial URL added as followable link');
    ...
    GNF5_Research::store($id,$research);
